...
VALUES
  ...
  ('private', 'ensure_moderation_f0_ledger', ARRAY[]::text[]),
  ...
  ('public', 'claim_approved_unmaterialized_moderation_jobs', ARRAY['service_role']),
  ...
  ('public', 'confirm_moderation_budget', ARRAY['service_role']),
  ...
  ('public', 'mark_moderation_job_materialized', ARRAY['service_role']),
  ...
  ('public', 'release_moderation_budget_if_unused', ARRAY['service_role']),
  ...
  ('public', 'reserve_moderation_budget', ARRAY['service_role']),
