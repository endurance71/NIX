    ...
    privacy: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: 'Dane mogą być przetwarzane przez Supabase (uwierzytelnianie, baza, Storage i funkcje serwerowe w UE), Apple (Sign in with Apple i App Store) oraz Expo/EAS (budowa, dystrybucja i powiadomienia push), tylko w zakresie koniecznym do usługi. Logowanie Google jest nieaktywne i nie przekazuje danych. W kontrolowanych buildach testowych Sentry może otrzymywać techniczne kategorie błędów i czasy uruchomienia bez tokenów, treści, e-maili, nazw ani identyfikatorów użytkowników.',
        },
        {
  ...
  en: {
    privacy: {
      ...
      sections: [
        ...
        { title: 'Recipients', body: 'Data may be processed by Supabase (authentication, database, Storage and server functions in the EU), Apple (Sign in with Apple and App Store), and Expo/EAS (builds, distribution and push notifications), only as needed. Google Sign-In is inactive and sends no data. In controlled test builds, Sentry may receive technical error categories and startup timings without tokens, content, emails, names, or user identifiers.' },
