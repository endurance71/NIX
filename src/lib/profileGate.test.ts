...
describe('resolveNeedsOnboarding', () => {
  it('zwraca false bez sesji', () => {
    ...
    expect(resolveNeedsOnboarding(false, { id: '1', username: null, display_name: null, bio: null, is_private: false, avatar_storage_path: null, avatar_emoji: null }, true, false)).toBe(
      false
    );
  });
  ...
  it('zwraca true gdy sesja jest, ale brak username', () => {
    expect(
      resolveNeedsOnboarding(true, { id: '1', username: null, display_name: null, bio: null, is_private: false, avatar_storage_path: null, avatar_emoji: null }, false, true)
    ).toBe(true);
  ...
  it('zwraca false gdy sesja jest i username ustawiony', () => {
    expect(
      resolveNeedsOnboarding(
        true,
        { id: '1', username: 'nix_user', display_name: null, bio: null, is_private: false, avatar_storage_path: null, avatar_emoji: null },
        false,
        true
      )
    ).toBe(false);
