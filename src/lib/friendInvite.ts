export const FRIEND_INVITE_PATH = 'friend-invite';

export function buildFriendInviteLink(token: string) {
...
export function extractFriendInviteToken(value: string) {
  return extractFriendInvitePayload(value)?.token ?? null;
}
