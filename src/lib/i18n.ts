  ...
  pl: {
    translation: {
      ...
      inbox: {
        ...
        uploadRetryScheduled: 'Ponowimy automatycznie',
      ...
      chat: {
        ...
        uploadPreparing: 'Przygotowywanie…',
        uploadActive: 'Wysyłanie · {{percent}}%',
        uploadWaitingNetwork: 'Czeka na sieć',
        uploadRetryScheduled: 'Ponowimy automatycznie',
        uploadPaused: 'Wstrzymano',
        uploadAttention: 'Wysyłka wymaga uwagi',
        uploadAttentionHelp: 'Nie udało się wysłać. Ponów próbę albo anuluj wysyłkę.',
        uploadPermanentFailureHelp: 'Tego pliku nie można wysłać. Anuluj wysyłkę.',
        uploadCompleted: 'Wysłano',
  ...
  en: {
    translation: {
      ...
      inbox: {
        ...
        uploadRetryScheduled: 'We’ll retry automatically',
        uploadPaused: 'Paused',
      ...
      chat: {
        ...
        uploadPreparing: 'Preparing…',
        uploadActive: 'Sending · {{percent}}%',
        uploadWaitingNetwork: 'Waiting for network',
        uploadRetryScheduled: 'We’ll retry automatically',
        uploadPaused: 'Paused',
        uploadAttention: 'Upload needs attention',
        uploadAttentionHelp: 'The upload failed. Retry it or cancel the upload.',
        uploadPermanentFailureHelp: 'This file cannot be sent. Cancel the upload.',
        uploadCompleted: 'Sent',
