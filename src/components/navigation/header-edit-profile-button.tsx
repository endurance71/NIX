...
export function HeaderEditProfileButton() {
  const { colors } = useAppTheme();
  const { t } = useTranslation();
  const label = t('profile.editProfileA11y');
    ...
    return (
      <Host matchContents style={styles.host}>
        <Button
          ...
          <SwiftImage
            systemName={resolveAppIconName('edit') as SFSymbol}
  ...
  return (
    <PressableScale
      ...
      <AppIcon name="edit" size={APP_ICON_SIZE.xl} color={colors.accent} />
    </PressableScale>
  );
}
